...
/*   Updated: 2019/06/17 13:17:50 by syeresko         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_opt const		*opt_info(size_t index)
{
	static t_opt const	opt_array[OPT_COUNT] = {
		{'w', 480, 4000, 800, OPT_INDEX_WIDTH},
		{'h', 360, 2000, 600, OPT_INDEX_HEIGHT},
		{'i', 1, 1000, 100, OPT_INDEX_ITER},
		{'c', 1, 5, 2, OPT_INDEX_COLOR},
	};
